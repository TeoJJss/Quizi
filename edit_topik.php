...
if (isset($_POST['update'])){
	...
	//KEMASKINI DENGAN REKOD BAHARU
	$result = mysqli_query($hubung, "UPDATE topik 
	SET topik='$topikBaru', markah='$markahBaru'
...
//DAPATKAN DATA LAMA
	...
	$pilihTopik = mysqli_query($hubung, "SELECT * FROM topik
	WHERE idtopik=$topikEdit");
