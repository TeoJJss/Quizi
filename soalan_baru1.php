...
?>
<?php
//PROSES TAMBAH SOALAN BAHARU
if (isset($_POST['submit'])){
	if ($_FILES['gambar']['name']==NULL){ //JIKA TIADA GAMBAR DIMASUKKAN
		$newnamepic="";
	}else{ //JIKA ADA GAMBAR, PAPARKAN GAMBAR
...
name="idtopik" hidden /></p >
<p><label>Soalan</label><textarea id="paparan_soalan"
name="paparan_soalan" rows="7" cols="105" required>
</textarea></p >
 <p><label>Gambar<br><small style="color:red">*Jika perlu
</small></label><input type="file" name="gambar"/></p >
<p><label>Pilihan 1: </label><input type="text"
name="pilih1" size="50" /></p>

<p><label>Pilihan 2: </label><input type="text"
name="pilih2" size="50"/></p>
<p><label>Pilihan 3: </label><input type="text"
name="pilih3" size="50"/></p>
<p><label>Pilihan 4: </label><input type="text"
name="pilih4" size="50"/></p>
<p><label>Pilihan Jawapan [1-4] </label><input type="text"
name="jawapan_betul" size="5" required /></p>
<fieldset><legend>MENU</legend><CENTER><input
type="submit" name="submit" value="CIPTA" /><button onclick="window.location.href='papar_topik.php'">TAMAT
