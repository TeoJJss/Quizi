...
name="nom_soalan" hidden /></p >
<p><label>Topik : </label><br><input type="text"
name="paparan_topik" size="60" placeholder="TAIP DI SINI"
required /></p >
<p><label>Jenis Soalan :</label><br><select name="jenis"
required>
...
<p><label>Markah: </label><br><input type="text"
name="markah" placeholder="1-100" maxlength='3'size="7"
