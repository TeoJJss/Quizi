...
//TABLE SOALAN
$dataSoalan=mysqli_query($hubung, "SELECT * FROM soalan WHERE idtopik=$getTopik[idtopik]"); //xblh ade jenis=$jenis
...
<button title="Saya telah bersedia!">MULAKAN</button></a>
<a href="pilihan_topik.php"><button title="Kembali">BATALKAN</button></a>
</td>
</tr>
</table>
</main>
