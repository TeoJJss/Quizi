<BR><BR><BR>
<?php
//PAPAR PRESTASI IKUT TAJUK BERDASARKAN PENGLIBATAN PELAJAR
...
while ($infoTopik=mysqli_fetch_array($topik)){
	...
	as 'bil'FROM perekodan WHERE idtopik='$infoTopik[idtopik]'");
 ...
 ?>
	...
	<?php echo $infoTopik['idtopik'];?>"><button title="Buka laporan pelajar yang telah jawab">BUKA
	</button></a></td>
		</tr>
	<?php $no++; 
} ?>
